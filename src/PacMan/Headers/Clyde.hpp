...
Clyde::Clyde() : Ghost(Orange, EntityType::eClyde){
	this->ScatterTarget.ModCoords((WindowWidth/2 - BoardWidth*BlockSize24/2) +BlockSize24 / 2, 35 * BlockSize24 + BlockSize24/ 2);
	this->Home.ModCoords((WindowWidth/2 - BoardWidth*BlockSize24/2) +15 * BlockSize24 + BlockSize24 / 2, 17 * BlockSize24 + BlockSize24 / 2);
}
