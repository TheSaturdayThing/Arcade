...
Inky::Inky() : Ghost(Cyan, EntityType::eInky){
	this->ScatterTarget.ModCoords((WindowWidth/2 - BoardWidth*BlockSize24/2) +26 * BlockSize24 + BlockSize24 / 2, 35 * BlockSize24 + BlockSize24 / 2);
	this->Home.ModCoords((WindowWidth/2 - BoardWidth*BlockSize24/2) +11 * BlockSize24 + BlockSize24 / 2, 17 * BlockSize24 + BlockSize24 / 2);
}
