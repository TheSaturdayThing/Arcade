...
Blinky::Blinky() : Ghost(Red, EntityType::eBlinky){
	this->ScatterTarget.ModCoords((WindowWidth/2 - BoardWidth*BlockSize24/2) +25 * BlockSize24 + BlockSize24 / 2, BlockSize24 / 2);
	this->Home.ModCoords((WindowWidth/2 - BoardWidth*BlockSize24/2) +13 * BlockSize24 + BlockSize24 / 2, 17 * BlockSize24 + BlockSize24 / 2);
}
